...
in {
  # Consolidate systemd.user.* to avoid repeated keys
  systemd.user = {
    startServices = "sd-switch"; # Start/stop user services via sd-switch

    services."dotfiles-cleanup" = {
      Unit = {
